...
$router->get('/bicicletas', [PaginasController::class, 'bicicletas']);
$router->post('/bicicletas', [PaginasController::class, 'bicicletas']);
$router->get('/bicicleta', [PaginasController::class, 'bicicleta']);
$router->post('/bicicleta', [PaginasController::class, 'bicicleta']);
